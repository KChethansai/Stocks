...
// Simple SVG line chart — ponytail: inline, no lib needed
function MiniChart() {
  return (
    <svg className="w-full h-full" viewBox="0 0 400 140" fill="none" preserveAspectRatio="none" aria-hidden="true">
      ...
      />
      {/* Entry line */}
      <line x1="0" y1="90" x2="400" y2="90" stroke="#3B82F6" strokeWidth="0.5" strokeDasharray="4 4" opacity="0.4" />
      <text x="4" y="88" fill="#3B82F6" fontSize="9" fontFamily="monospace" opacity="0.6">Entry $85.00</text>
      {/* Current price */}
      <circle cx="400" cy="18" r="4" fill="#3B82F6" />
      <text x="360" y="12" fill="#3B82F6" fontSize="9" fontFamily="monospace">$94.28</text>
    </svg>
  )
}
      ...
      <div className="mf-scene">
        <div className="mf-scene-frame">
          ...
          >
            ...
            >
              <BorderBeam size={160} duration={10} colorFrom="#3B82F6" colorTo="#22C55E" />
