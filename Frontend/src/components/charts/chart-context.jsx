...
function ChartProvider({
  ...
  return /* @__PURE__ */ React.createElement(ChartStableContext.Provider, { value: stable }, /* @__PURE__ */ React.createElement(ChartHoverContext.Provider, { value: hover }, children));
}
...
var chart_context_default = ChartStableContext;
export {
  ChartProvider,
  chartCssVars,
  chart_context_default as default,
