...
function LoadingSweepMask({
  ...
  return /* @__PURE__ */ React.createElement(React.Fragment, null, /* @__PURE__ */ React.createElement("linearGradient", { id: `${chartId}-grad`, x1: "0", x2: "1", y1: "0", y2: "0" }, gradientStops.map(({ offset, opacity }) => /* @__PURE__ */ React.createElement(
    "stop",
    {
      key: offset,
      offset,
  ...
  ), /* @__PURE__ */ React.createElement("mask", { id: `${chartId}-mask`, maskUnits: "userSpaceOnUse" }, /* @__PURE__ */ React.createElement("rect", { fill: `url(#${chartId}-pattern)`, height, width })));
}
function LineLoadingSweep({
  ...
  const silhouette = /* @__PURE__ */ React.createElement(React.Fragment, null, withArea ? /* @__PURE__ */ React.createElement(
    AreaClosed,
    {
      curve,
      data: points,
  ...
  const areaGradient = withArea ? /* @__PURE__ */ React.createElement("linearGradient", { id: `${chartId}-area`, x1: "0", x2: "0", y1: "0", y2: "1" }, /* @__PURE__ */ React.createElement(
    "stop",
    {
      offset: "0%",
      stopColor: stroke,
  ...
  if (reduceMotion) {
    return /* @__PURE__ */ React.createElement(React.Fragment, null, areaGradient ? /* @__PURE__ */ React.createElement("defs", null, areaGradient) : null, silhouette);
  }
  const maskUrl = `url(#${chartId}-mask)`;
  const defs = /* @__PURE__ */ React.createElement("defs", null, areaGradient, /* @__PURE__ */ React.createElement(
    LoadingSweepMask,
    {
      chartId,
      durationSeconds,
  ...
  if (isLoop) {
    return /* @__PURE__ */ React.createElement(React.Fragment, null, defs, /* @__PURE__ */ React.createElement("g", { mask: maskUrl }, silhouette));
  }
  return /* @__PURE__ */ React.createElement(React.Fragment, null, defs, /* @__PURE__ */ React.createElement(
    motion.g,
    {
...
function SkeletonBars({
  ...
  return /* @__PURE__ */ React.createElement(React.Fragment, null, heights.map((value, i) => {
...
function BarLoadingSkeleton({
  ...
  const bars = /* @__PURE__ */ React.createElement(
    SkeletonBars,
    {
      barFraction,
      baseline,
  ...
  return /* @__PURE__ */ React.createElement(React.Fragment, null, /* @__PURE__ */ React.createElement("defs", null, /* @__PURE__ */ React.createElement(
    LoadingSweepMask,
    {
      chartId,
      durationSeconds,
  ...
  )), /* @__PURE__ */ React.createElement("g", { mask: `url(#${chartId}-mask)` }, bars));
}
