...
function SeriesMarkers({
  ...
  if (isRevealing) {
    return /* @__PURE__ */ React.createElement("g", null, points.map((point) => /* @__PURE__ */ React.createElement(
      SeriesPointMarker,
      {
        cx: point.cx,
        cy: point.cy,
  ...
  const baseMarkers = points.map((point) => /* @__PURE__ */ React.createElement(
    StaticSeriesPointMarker,
    {
      cx: point.cx,
      cy: point.cy,
...
var series_markers_default = SeriesMarkers;
export {
  SeriesMarkers,
  series_markers_default as default
};
