...
function TooltipBox(props) {
  ...
  return /* @__PURE__ */ React.createElement(TooltipBoxInner, { ...props, container });
}
function TooltipBoxInner({
  ...
  if (animate && leftOverride === void 0) {
    animatedLeft.set(targetX);
  }
  if (animate && topOverride === void 0) {
  ...
  if (!entrance) {
    return createPortal(
      /* @__PURE__ */ React.createElement(
        ...
        /* @__PURE__ */ React.createElement("div", { className: panelClassName, style: panelStyleResolved }, children)
      ),
      container
    );
  }
...
var tooltip_box_default = TooltipBox;
export {
  TooltipBox,
  tooltip_box_default as default
};
