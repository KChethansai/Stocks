...
function TimeSeriesChartInner(props) {
  ...
  return /* @__PURE__ */ React.createElement(TimeSeriesChartCore, { ...props });
}
const TimeSeriesChartCore = memo(function TimeSeriesChartCore2({
  ...
  return /* @__PURE__ */ React.createElement(
    ...
    /* @__PURE__ */ React.createElement(ChartProvider, { value: contextValue }, /* @__PURE__ */ React.createElement("svg", { "aria-hidden": "true", height, width }, /* @__PURE__ */ React.createElement("defs", null, defsChildren, useClipReveal ? /* @__PURE__ */ React.createElement(
      ChartRevealClip,
      {
    ...
    ) : null), /* @__PURE__ */ React.createElement("rect", { fill: "transparent", height, width, x: 0, y: 0 }), /* @__PURE__ */ React.createElement(
      "g",
      {
        ...interactionHandlers,
      ...
      underlayChildren,
      useClipReveal ? /* @__PURE__ */ React.createElement("g", { clipPath: `url(#${clipPathId})` }, preOverlayChildren) : preOverlayChildren,
      postOverlayChildren
    )))
  );
});
