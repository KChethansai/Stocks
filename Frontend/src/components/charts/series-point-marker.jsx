...
function MarkerCircles({
  ...
  return /* @__PURE__ */ React.createElement(React.Fragment, null, outlineWidth > 0 ? /* @__PURE__ */ React.createElement(
    "circle",
    {
      cx: 0,
      cy: 0,
  ...
  ) : null, /* @__PURE__ */ React.createElement("circle", { cx: 0, cy: 0, fill, r: radius }), strokeWidth > 0 ? /* @__PURE__ */ React.createElement(
    "circle",
    {
      cx: 0,
      cy: 0,
...
const StaticSeriesPointMarker = memo(function StaticSeriesPointMarker2({
  ...
  return /* @__PURE__ */ React.createElement("g", { transform: `translate(${cx}, ${cy}) scale(${scale})` }, /* @__PURE__ */ React.createElement(
    MarkerCircles,
    {
      fill,
      outlineColor,
...
function SeriesPointMarker({
  ...
  return /* @__PURE__ */ React.createElement("g", { transform: `translate(${cx}, ${cy})` }, /* @__PURE__ */ React.createElement(
    motion.g,
    {
      animate: "visible",
      initial: "hidden",
